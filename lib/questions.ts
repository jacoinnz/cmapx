...
export const questions: Question[] = [
  ...
  },
  {
    ...
    kind: "maturity",
    weight: 1,
    text: "Do you know which outside companies and online services can access your business data (like your IT provider, accountant or cloud apps)?",
    helpText: "You can't protect data you've lost track of — knowing who holds it is the first step.",
    recommendation: "List the outside providers and online services that can access your business data.",
  },
  {
    id: "acc_supplier_safe",
    categoryId: "access",
    kind: "maturity",
    weight: 1,
    text: "Are you confident those providers take security seriously — for example they're reputable, use two-step login, and would tell you quickly if they were breached?",
    helpText: "Attackers increasingly break in through a trusted supplier, so your providers' security is part of your own.",
    recommendation: "Check that key providers take security seriously, and prefer ones that can show it.",
  },
  ...
  },
  {
    ...
    kind: "maturity",
    weight: 1,
    text: "Have you talked with your team about how criminals impersonate trusted people, and agreed to double-check unusual or urgent requests through a second, known channel?",
    helpText: "Criminals piece together public details to convincingly impersonate you and trick staff or suppliers — a quick agreed check stops most of it.",
    recommendation: "Agree a simple rule: verify any unusual or urgent request through a second, known channel before acting.",
  },
  {
    id: "ppl_mdm",
    categoryId: "people",
  ...
  },
  {
    ...
    kind: "maturity",
    weight: 1,
    text: "Do you know who you'd need to notify after a cyber attack or data breach — for example the NCSC, your bank, and affected customers — and how to reach them quickly?",
    helpText: "Knowing your notification list in advance saves critical time: the NCSC (which now includes the former CERT NZ) offers free help, and the Privacy Act 2020 may require telling affected people.",
    recommendation: "Write down who to notify after a breach (NCSC, bank, insurer, affected customers) and how to reach them.",
  },
  {
    id: "res_downtime",
    categoryId: "response",
